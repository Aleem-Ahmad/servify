      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <motion.div
            ...
            className={`w-full lg:w-[400px] flex-shrink-0 provider-card ${dark ? "dark" : ""}`}
          >
            ...
            <div className="px-8 pb-8 flex flex-col items-center text-center -mt-16 relative z-10">
              ...
              <div className="rating-badge mb-6">
                {avgRating ? (
              ...
              <div className="w-full mt-8 space-y-4 text-sm text-left">
                {provider.phone && (
                  <div className="info-item">
                    <div className="info-icon"><Phone className="w-4 h-4" /></div>
                    {provider.phone}
                  </div>
                )}
                {provider.city && (
                ...
                {provider.email && (
                  <div className="info-item">
                    <div className="info-icon"><Mail className="w-4 h-4" /></div>
                    {provider.email}
                  </div>
                )}
              </div>
          ...
          <div className="flex-1 space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className={`section-card ${dark ? "dark" : ""}`}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className={`section-card ${dark ? "dark" : ""}`}>
              ...
              {reviews.length === 0 ? (
                ...
                <div className="space-y-6">
                  {reviews.map((rev) => (
                    <div key={rev._id} className={`review-card ${dark ? "dark" : ""}`}>
